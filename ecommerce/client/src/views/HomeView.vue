        ...
        <div  v-for="(product, i) in inventory" :key="i" class=" w-full max-w-sm  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="px-5 pb-5 text-center">
                ...
                <div class="flex items-center justify-between mt-2">
                    ...
                    <button type="button" @click="add(product.name, i)" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</button>
                </div>
            </div>
        </div>
    </div>
